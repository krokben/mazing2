...
const initialState = {
	...
	tiles: [
		...
		{id:   2, x:  64, y:   0, color: 'lightpink', group:  1, clickable: true},
		...
		{id:   6, x:   0, y:  64, color: 'lightblue', group:  2, clickable: true},
		...
		{id:  17, x:  64, y: 192, color: 'lightpink', group:  4, clickable: false},
		...
		{id:  22, x:  64, y: 256, color: 'lightpink', group:  5, clickable: false},
		...
		{id:  33, x: 448, y:  64, color: 'lightpink', group: 12, clickable: false},
		{id:  34, x: 512, y:  64, color: 'lightpink', group: 12, clickable: false},
		{id:  35, x: 576, y:  64, color: 'lightpink', group: 12, clickable: false},
		{id:  36, x: 320, y: 128, color: 'lightblue', group: 13, clickable: false},
		{id:  37, x: 384, y: 128, color: 'lightblue', group: 13, clickable: false},
		{id:  38, x: 448, y: 128, color: 'lightpink', group: 13, clickable: false},
		...
		{id:  43, x: 448, y: 192, color: 'lightpink', group: 14, clickable: false},
		...
		{id:  48, x: 448, y: 256, color: 'lightpink', group: 15, clickable: false},
		...
		{id:  52, x:  64, y: 320, color: 'lightpink', group:  6, clickable: false},
		...
		{id:  57, x:  64, y: 384, color: 'lightpink', group:  7, clickable: false},
		{id:  58, x: 128, y: 384, color: 'lightpink', group:  7, clickable: false},
		{id:  59, x: 192, y: 384, color: 'lightpink', group:  7, clickable: false},
		{id:  60, x: 256, y: 384, color: 'lightpink', group:  7, clickable: false},
		...
		{id:  71, x:   0, y: 576, color: 'lightpink', group: 10, clickable: false},
		{id:  72, x:  64, y: 576, color: 'lightpink', group: 10, clickable: false},
		{id:  73, x: 128, y: 576, color: 'lightpink', group: 10, clickable: false},
		{id:  74, x: 192, y: 576, color: 'lightpink', group: 10, clickable: false},
		{id:  75, x: 256, y: 576, color: 'lightpink', group: 10, clickable: false},
		{id:  76, x: 320, y: 320, color: 'lightblue', group: 16, clickable: false},
		{id:  77, x: 384, y: 320, color: 'lightblue', group: 16, clickable: false},
		{id:  78, x: 448, y: 320, color: 'lightpink', group: 16, clickable: false},
		{id:  79, x: 512, y: 320, color: 'lightblue', group: 16, clickable: false},
		{id:  80, x: 576, y: 320, color: 'lightblue', group: 16, clickable: false},
		{id:  81, x: 320, y: 384, color: 'lightpink', group: 17, clickable: false},
		{id:  82, x: 384, y: 384, color: 'lightpink', group: 17, clickable: false},
		{id:  83, x: 448, y: 384, color: 'lightpink', group: 17, clickable: false},
		{id:  84, x: 512, y: 384, color: 'lightblue', group: 17, clickable: false},
		{id:  85, x: 576, y: 384, color: 'lightblue', group: 17, clickable: false},
		{id:  86, x: 320, y: 448, color: 'lightpink', group: 18, clickable: false},
		...
		{id:  91, x: 320, y: 512, color: 'lightpink', group: 19, clickable: false},
		...
		{id:  96, x: 320, y: 576, color: 'lightpink', group: 20, clickable: false},
